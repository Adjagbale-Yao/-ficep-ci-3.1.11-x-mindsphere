            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="ui-basic1">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('home/machine-monitoring/default'); ?>">Machine
                                    Monitoring</a></li>
                            <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('home/alarms/'); ?>">
                                    Alarms </a></li>
                ...
                <li class="nav-item menu-items active">
                    ...
                    <div class="collapse" id="ui-basic2">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link font-weight-bold">Analytics</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item menu-items">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-3  grid-margin stretch-card">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="text-muted mb-1">OEE</h6>
                                </div>
                                <div class="card-body">
                                    <!-- <div class="d-flex d-md-block d-xl-flex flex-row px-4 px-md-3 px-xl-4 rounded pt-2">
                                        <div id="donut_single" class="align-self-center flex-grow text-right text-md-center text-xl-center py-md-2 py-xl-0 h4">
                                        </div>
                                    </div> -->
                                    <div id="containerOee" class="h1"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6  grid-margin stretch-card">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="text-muted mb-1">OEE COMPONENTS</h6>
                                </div>
                                <div class="card-body">
                                    <div class="d-flex d-md-block d-xl-flex flex-row px-4 px-md-3 px-xl-4 rounded pt-2">
                        ...
                        <div class="col-md-3  grid-margin stretch-card">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="text-muted mb-1">PRODUCTIVE TIME - DAY</h6>
                                </div>
                                <div class="card-body">
                                    <div class="col grid-margin px-md-3 px-xl-4">
                                        <div class="row d-flex justify-content-center">
                                            <p><label class="font-weight-bold text-dark mt-0">Actual: </label>
                                                <span class="text-muted h2">11:23:50</span>
                                            </p>
                                        </div>
                                        <div class="bg-secondary bg-gradient">
                                            <div class="row d-flex justify-content-center">
                                                <p class="text-center">
                                                    <span class="font-weight-bold text-dark mt-1">Produced pieces:
                                                    </span><br>
                                                    <span class="text-muted h2">821</span>
                                                </p>
                                            </div>
                                            <div class="row d-flex justify-content-center">
                                                <p class="text-center">
                                                    <span class="font-weight-bold text-dark mt-1">Target pieces: </span> <br>
                                                    <label class="text-muted h2">15650</label>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="text-muted mb-1">OEE TREND</h6>
                                </div>
                                <div class="card-body">
                                    <div class="d-flex d-md-block d-xl-flex flex-row px-4 px-md-3 px-xl-4 rounded pt-2">
                                        <input type="button" value="Toogle Fullscreen" id="fs-oee_trend-button">
                                        <input type="button" value="Save as PDF" id="save-oee_trend-pdf" disabled>
                                    </div>
                                    <div class="d-flex d-md-block d-xl-flex flex-row px-4 px-md-3 px-xl-4 rounded pt-2">
                                        <div id="oee_line_chart" class="align-self-center flex-grow text-right text-md-center text-xl-center py-md-2 py-xl-0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="text-muted mb-1">PRODUCTION TREND</h6>
                                </div>
                                <div class="card-body">
                                    <div class="d-flex d-md-block d-xl-flex flex-row px-4 px-md-3 px-xl-4 rounded pt-2">
                                        <input type="button" value="Toogle Fullscreen" id="fs-prod_trend-button">
                                        <input type="button" value="Save as PDF" id="save-prod_trend-pdf" disabled>
                                    </div>
                                    <div class="d-flex d-md-block d-xl-flex flex-row px-4 px-md-3 px-xl-4 rounded pt-2">
                                        <div id="oee_area_chart" class="align-self-center flex-grow text-right text-md-center text-xl-center py-md-2 py-xl-0">
                                        </div>
                                    </div>
                                </div>
                            </div>
