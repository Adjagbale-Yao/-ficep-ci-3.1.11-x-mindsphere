...
<body>
  <div class="container-scroller">
      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items active">
          ...
          <div class="collapse" id="ui-basic3">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link font-weight-bold"> Process Log</a></li>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <!-- selection of kpi data to plot -->
          <div class="row">
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
              <div type="button" class="card btn dropdown-toggle d-block text-muted" onclick="showCheckboxes()" data-toggle="checkboxes">
                <h4>SELECT KPI</h4>
              </div>
              <div class="bg-transparent border-0 dropdown-menu w-100" id="checkboxes">
                <div class="card ml-2">
                  <form class="form-group form-check" id="kpiProcessLogFormId" action="" method="GET">
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_0" type="checkbox" class="custom-control-input" value="VALORE ATTUALE CONTROLLO DI SFORZO">
                      <label for="checkbox_0" class="custom-control-label text-muted">VALORE ATTUALE CONTROLLO DI SFORZO</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_1" type="checkbox" class="custom-control-input" value="TEMPERATURE ANALOGICHE">
                      <label for="checkbox_1" class="custom-control-label text-muted">TEMPERATURE ANALOGICHE</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_2" type="checkbox" class="custom-control-input" value="PRESSOSTATI ANALOGICHE">
                      <label for="checkbox_2" class="custom-control-label text-muted">PRESSOSTATI ANALOGICHE</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_3" type="checkbox" class="custom-control-input" value="BATTUTE PRESSA">
                      <label for="checkbox_3" class="custom-control-label text-muted">BATTUTE PRESSA</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_4" type="checkbox" class="custom-control-input" value="TEMPERATURE ASSI">
                      <label for="checkbox_4" class="custom-control-label text-muted">TEMPERATURE ASSI</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_5" type="checkbox" class="custom-control-input" value="CORRENTE ASSI">
                      <label for="checkbox_5" class="custom-control-label text-muted">CORRENTE ASSI</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_6" type="checkbox" class="custom-control-input" value="POTENZA ASSI">
                      <label for="checkbox_6" class="custom-control-label text-muted">POTENZA ASSI</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_7" type="checkbox" class="custom-control-input" value="PEZZI PRODOTTI">
                      <label for="checkbox_7" class="custom-control-label text-muted">PEZZI PRODOTTI</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_8" type="checkbox" class="custom-control-input" value="CORRENTE ASSORBITA (L1,L2,L3)">
                      <label for="checkbox_8" class="custom-control-label text-muted">CORRENTE ASSORBITA (L1,L2,L3)</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_9" type="checkbox" class="custom-control-input" value="POTENZA ATTIVA">
                      <label for="checkbox_9" class="custom-control-label text-muted">POTENZA ATTIVA</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_10" type="checkbox" class="custom-control-input" value="POTENZA REATTIVA">
                      <label for="checkbox_10" class="custom-control-label text-muted text-muted">POTENZA REATTIVA</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_11" type="checkbox" class="custom-control-input" value="COEFFICIENTE DI RISCALDAMENTO">
                      <label for="checkbox_11" class="custom-control-label text-muted text-muted">COEFFICIENTE DI RISCALDAMENTO</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input name="checkbox" id="checkbox_12" type="checkbox" class="custom-control-input" value="SET BATTUTE">
                      <label for="checkbox_12" class="custom-control-label text-muted">SET BATTUTE</label>
                    </div>
                    <div class="d-flex justify-content-between pr-3">
                      <input type="submit" name="SELECT" id="kpiButtonId" class="btn btn-primary"></input>
                      <button type="button" class="btn btn-primary" onclick="document.getElementById('kpiProcessLogFormId').reset()">Clear</button>
                    </div>
                  </form>
                </div>
              </div>
    ...
    <script type="text/javascript">
      var data = <?php echo json_encode("<?php include 'ficep_kpi_widget.php' ?>") ?>;
    </script>
