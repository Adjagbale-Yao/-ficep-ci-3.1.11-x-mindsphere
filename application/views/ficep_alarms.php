              ...
              <div class="card d-flex align-items-center justify-content-center">
                <div class="form-check">
                  <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios1" value="option1" checked=""/>  REAL TIME <i class="input-helper"></i>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div class="col grid-margin stretch-card">
              <div class="card d-flex align-items-center justify-content-center">
                <div class="custom-control custom-switch">
                  ...
                  <label class="custom-control-label h4 text-muted" for="customSwitch1">ALL ALARMS</label>
                </div>
              </div>
            </div>
            <div class="col"></div>
          ...
          <div class="row">
            ...
            <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
              <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search w-50">
                <input type="text" class="form-control" id="searchId" onkeyup="searchFunction()" placeholder="Search ...">
              </form>
            </div>
          </div>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Active Alarms</h4>
                </div>
                    ...
                    <table class="table">
                      ...
                      <tbody id="tableBodyId">
                        <tr id="30">
                          <td>
                            <span class="menu-icon">
                              <i class="mdi mdi mdi mdi-alert-outline alt-damage"></i>
                              <h8>30</h8>
                            </span>
                          </td>
                          <td> Allarme - Porta 46 </td>
                          <td> 01 June 2021 11:01:90</td>
                          <td> 01 June 2021 11:31:40</td>
                          <td> 1:31:40 </td>
                        </tr>
                        ...
                        <tr id="77">
                          ...
                          <td> Allarme - Slitta sottoquadro </td>
                          <td> 01 June 2021 11:01:90</td>
                          <td> 01 June 2021 11:31:40</td>
                          <td> 1:31:40 </td>
                        </tr>
                        ...
                        <tr id="94">
                          <td>
                            <span class="menu-icon">
                              <i class="mdi mdi mdi mdi-alert-outline alt-warning"></i>
                              <h8>94</h8>
                            </span>
                          </td>
                          <td> Allarme - Cancello 7 </td>
