        ...
        <div class="content-wrapper">
          ...
          <div class=row>
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">TOTAL STOPS</h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="text-black-50">192</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">DOWNTIME </h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="text-black-50">102h:35m:40s</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">MTBF </h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="text-black-50">2h:35m:40s</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">MTTR </h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="text-black-50">00h:34m:08s</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h5 class="text-black-50">PARETO CHART</h5>
                  </div>
                </div>
              </div>
            </div>
