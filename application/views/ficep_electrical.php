      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items active">
          ...
          <div class="collapse" id="ui-basic6">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"><a class="nav-link font-weight-bold"> Electrical Consumption </a></li>
        ...
        <div class="content-wrapper">
          ...
          <div class=row>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">TOTAL CONSUMPTION [kWh]</h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">98.3 kWh</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1"> RELATIVE CONSUMPION [kWh/piece]</h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">92.56 kWh/piece</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">AVERAGE CONSUMPTION [Kwh/DAY]</h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">3.28 kWh</h1>
                  </div>
                </div>
              </div>
            </div>
