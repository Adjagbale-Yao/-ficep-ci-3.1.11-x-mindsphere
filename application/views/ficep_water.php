...
<body>
  <div class="container-scroller">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic5">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"><a class="nav-link" href="<?php echo base_url('home/maintenance-process-log/'); ?>"> Pareto + KPI </a></li>
        ...
        <li class="nav-item menu-items active">
          ...
          <div class="collapse" id="ui-basic6">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"><a class="nav-link font-weight-bold">Water Consumption </a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item menu-items">
        ...
        <div class="content-wrapper">
          ...
          <div class=row>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">1062</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">TOTAL CONSUMPTION [lt]</h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">2407 lt</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1"> RELATIVE CONSUMPION [lt/piece]</h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">2.56 lt/piece</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">AVERAGE CONSUMPTION [lt/DAY]</h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">80.28 lt</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">PARETO CHART</h6>
                </div>
                <div class="card-body">
                  <div class="d-flex d-md-block d-xl-flex flex-row px-4 px-md-3 px-xl-4 rounded pt-2">
                    <div class="align-self-center flex-grow text-right text-md-center text-xl-center py-md-2 py-xl-0">
                      <p class="text-muted mb-0"></label>Grafico</p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <script src="../../public/assets/js/kpi_search.js"></script>
