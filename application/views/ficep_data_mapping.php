                ...
                <li class="nav-item menu-items active">
                    ...
                    <div class="collapse" id="ui-basic7">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link font-weight-bold"> Data Mapping </a></li>
                        </ul>
                    </div>
                </li>
            </ul>
                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <h2 class="card-title text-dark">Machine List</h2>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <label class="h3 text-dark-inverse"> Machine name </label>
                                                    </th>
                                                    <th>
                                                        <h3> Mapped datapoints </h3>
                                                    </th>
                                                    <th>
                                                        <h3> Stato </h3>
                                                    </th>
                                            ...
                                            <tbody >
                                                <?php if (is_countable($names) && count($names) > 0) : ?>
                                                    <?php foreach ($names as $name) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h4><?php echo "n" ?> / 917</h4>
                                                            </td>
                                                            <td>
                                                                <div class="align-items-center d-flex">
                                                                    <h4 class="mb-0 mx-2">mapping state </h4>
                                                                    <span class="dot dot-success"> </span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="d-flex justify-content-around">
                                                                    <button class="btn btn-facebook"><i class="mdi mdi-play-circle-outline mr-0"></i></button>
                                                                    <button class="btn btn-danger"><i class="mdi mdi-close-circle mr-0"></i></button>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
