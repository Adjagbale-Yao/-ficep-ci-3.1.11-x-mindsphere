        ...
        <li class="nav-item menu-items active">
          ...
          <div class="collapse" id="ui-basic1">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link font-weight-bold">Parameters</a></li>
        ...
        <div class="content-wrapper">
          ...
          <div class="row ">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <span class="menu-icon">
                              <i class="mdi mdi mdi mdi-flash "></i>
                              <h8> Frequency </h8>
                            </span>
                          </td>
                          <td> 18.32</td>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Stroke Sets</h4>
                </div>
                <div class="card-body pt-0">
                  <div class="table-responsive">
                    <table class="table">
          ...
          <div class="row ">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Sensors (analogic)</h4>
                </div>
                <div class="card-body pt-0">
                  <div class="table-responsive">
                    <table class="table" id="analogicTableId">
                      <thead>
                        <tr>
                          <th> Variable </th>
                          <th> Actual Value </th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> 100</td>
                          <td name="badge">
                            <label class="badge" name="badge"></label>
                          </td>
                        </tr>

                        <tr>
                          <td>Blower 1 speed</td>
                          <td> 441 </td>
                          <td> 0</td>
                          <td> 400</td>
                          <td name="badge">
