        ...
        <li class="nav-item menu-items active">
          ...
          <div class="collapse" id="ui-basic5">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"><a class="nav-link font-weight-bold">Pareto + KPI</a></li>
        ...
        <div class="content-wrapper">
          ...
          <div class=row>
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">TOTAL MAINTENANCE ALERTS</h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">192</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">TOTAL MAINTENANCE ETRA TIME </h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">102h:35m:40s</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">AVERAGE ONTIME MAINTENANCE </h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">2h:35m:40s</h1>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card">
                <div class="card-header">
                  <h6 class="text-muted mb-1">AVERAGE MAINTENANCE DELAY </h6>
                </div>
                <div class="card-body">
                  <div class="flex-grow text-right text-md-center text-xl-center">
                    <h1 class="font-weight-light text-black">00h:34m:08s</h1>
                  </div>
                </div>
              </div>
            </div>
